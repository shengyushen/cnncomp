...
set title  "Feature size of 2D flownet and 3D convolution with batch size 1"
...
plot "./fgfares/res3" u 2:($3*4*2):(sprintf("%dGB",$3*4*2/1024/1024/1024)) with linesp  notitle,\
     ...
     "./fgfares/resnet152" u 1:($2*1024*1024/128) with linesp notitle,\
       ...
       "" u 1:(4*$3*1024*1024) with linesp notitle, \
			"ltc_mem.txt"       u 2:($1==10 ?$3*1024*1024*1024:1/0) w linesp notitle,\
			""                  u 2:($1==100?$3*1024*1024*1024:1/0) w linesp notitle, \
			""                  u 2:($1==100?$3*1024*1024*1024:1/0):(sprintf("%dGB",$3)) w labels notitle
