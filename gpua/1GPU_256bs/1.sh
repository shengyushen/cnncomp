...
do
    ...
    #sh $test_dir/cluster-verbs.sh $batch $job_name $task_index
     ...
     CUDA_VISIBLE_DEVICES= time python /home/nfs/test/benchmarks-master/scripts/tf_cnn_benchmarks/tf_cnn_benchmarks.py --batch_size=$batch \
    ...
    --num_epochs=10 --data_format=NCHW --data_name=imagenet --data_dir=/home/nfs/resnet/train | tee batch"$batch"_ps_0.internel.log > batch"$batch"_ps_0.log 2>&1
