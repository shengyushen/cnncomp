...
do
    ...
    #sh $test_dir/cluster-verbs.sh $batch $job_name $task_index
     ...
     CUDA_VISIBLE_DEVICES= nvprof -f --quiet --profile-api-trace none --print-gpu-trace --print-nvlink-topology --csv --log-file ps_0_$batch.csv -o ps_0_$batch.nvvp \
    ...
    --num_batches=100 --data_format=NCHW --data_name=imagenet --data_dir=/home/nfs/resnet/train | tee batch"$batch"_ps_0.internel.log > batch"$batch"_ps_0.log 2>&1
